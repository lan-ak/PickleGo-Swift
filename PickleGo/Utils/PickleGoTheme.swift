...
struct PickleGoTheme {
    static let background = Color("PickleGoBackground")
    ...
    static let card = Color("PickleGoBackground") // Or use a different color if you have a card color
